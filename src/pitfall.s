...
TreasureCoord: .word 	264, 128,	# x, y pos of treasure
			0, 5, 7	# flags de controle pra saber se tesouro j� foi pego e em quais niveis tem algum tesouro (mas 3 por enquanto)
...
BACKGROUND:
	...
	rem t4, t0, t3	# resto da divis�o do nivel por 3 vai dar o bg certo
...
COLISION:
	...
	beq t1, a1, CheckFirstBarrelColision 	# verifica se player esta na mesma posi��o do barril
EndFirstBarrelColision:
	...
	beq t1, a1, CheckSecondBarrelColision 	# verifica se player esta na mesma posi��o do barril
EndSecondBarrelColision:
	...
	bne a0, a3, TCaux1
	li a4, 1
	beq t1, a1, CheckTreasureColision 	# verifica se player esta na mesma posi��o do tesouro
