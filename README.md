...
No caso de haver barris, ele pega as coordenadas x, y dos barris e chama a função BarrelPrint que por sua vez chama a macro barrel_print feita pelo jader (esses passos a mais são para evitar memory leak, novamente).No momento, esta função contempla apenas barris parados.
